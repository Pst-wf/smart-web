<template>
  <div class="clearfix">
    ...
    <a-modal :open="previewVisible" :title="previewTitle" :footer="null" :get-container="SmartLoading.spin" @cancel="handleCancel">
...
let props = defineProps({
  ...
  accept: {
    type: Array,
    default: () => ['png', 'jpg', 'jpeg', 'webp', 'gif', 'bmp', 'svg'],
  },
  multiple: {
    type: Boolean,
    default: false,
...
watch(
  () => props.fileList,
  (val) => {
    console.log('prop.fileList', props.fileList);
    dataSource.value =
      val === null || val === ''
        ? []
