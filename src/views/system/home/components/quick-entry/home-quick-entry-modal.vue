<template>
  <a-modal v-model:open="visible" title="新建快捷入口" :get-container="SmartLoading.spin" @close="onClose">
    <a-form ref="formRef" :model="form" :rules="rules">
      ...
      <a-form-item label="路径" name="path">
        <a-select v-model:value="form.path" allowClear :showSearch="true" optionFilterProp="label" placeholder="请选择路径" @change="changeSelect">
