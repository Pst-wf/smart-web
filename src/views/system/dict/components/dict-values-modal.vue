<template>
  ...
  >
    ...
    <div style="margin-top: 20px">
      ...
      <a-table :columns="columns" :data-source="dataSource" :loading="tableLoading" bordered :pagination="false"
               rowKey="id"
        ...
        <template #bodyCell="{ column, text, record }">
          ...
          <span v-if="editableData[record.id]">
            ...
            <a-button v-privilege="'dict:update'" danger type="link" @click="cancel(record.id)"
                      size="small">关闭</a-button>
          </span>
              <span v-else>
            <a-button v-privilege="'dict:add'" type="link" style="color: #4ab844" size="small"
                      @click="addRow(record.id, record.children ? record.children.length + 1 : 1)">新增</a-button>
