  ...
  >
    <div class="view-class">
      ...
      <div style="text-align: center;margin-top: 10px">
        <span>
          <span v-if="operateType === 'view'" style="text-align: center;color: #888c8e;font-size: 13px"> 发送人：{{ viewData.createUserName }}</span>
          <span v-if="operateType === 'get' || operateType === 'draft'" style="text-align: center;color: #888c8e;font-size: 13px">收件人：{{ viewData.receiveUserNames }}</span>
        </span>
