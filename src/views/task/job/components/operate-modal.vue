      ...
      <a-row v-if="operateType !== 'trigger'">
        <a-col :span="12">
          <a-form-item label="调度类型" name="scheduleType">
            <SmartEnumSelect enum-name="SCHEDULE_TYPE_ENUM" v-model:value="form.scheduleType"
                             placeholder="请选择调度配置"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
      ...
      <a-row v-if="operateType !== 'trigger'">
        <a-col :span="12">
          <a-form-item label="运行模式" name="glueType">
            <SmartEnumSelect enum-name="GLUE_TYPE_ENUM" v-model:value="form.glueType"
                             placeholder="请选择运行模式"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
      ...
      <a-row v-if="operateType !== 'trigger'">
        <a-col :span="12">
          <a-form-item label="路由策略" name="executorRouteStrategy">
            <SmartEnumSelect enum-name="EXECUTOR_ROUTE_STRATEGY_ENUM" v-model:value="form.executorRouteStrategy"
                             placeholder="请选择路由策略"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
      ...
      <a-row v-if="operateType !== 'trigger'">
        <a-col :span="12">
          <a-form-item label="调度过期策略" name="misfireStrategy">
            <SmartEnumSelect enum-name="MISFIRE_STRATEGY_ENUM" v-model:value="form.misfireStrategy"
                             placeholder="请选择调度过期策略"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="阻塞处理策略" name="executorBlockStrategy">
            <SmartEnumSelect enum-name="EXECUTOR_BLOCK_STRATEGY_ENUM" v-model:value="form.executorBlockStrategy"
