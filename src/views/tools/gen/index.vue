            ...
            <div class="smart-table-operate">
              ...
              <a-dropdown placement="bottomLeft">
                ...
                <template #overlay>
                  <a-menu>
                    <a-menu-item>
                      <a-button type="link" style="color: #1e1e1e" size="small" @click="preview(record)"> 预览 </a-button>
                    </a-menu-item>
                    <a-menu-item>
                      <a-button type="link" style="color: #1e1e1e" size="small" @click="confirmGenInFile(record)"> 生成代码 </a-button>
                    </a-menu-item>
                    <a-menu-item>
                      <a-button type="link" style="color: #1e1e1e" size="small" @click="saveMenu(record)">生成菜单 </a-button>
                    </a-menu-item>
                    <a-menu-item>
                      <a-button type="link" style="color: #1e1e1e" size="small" @click="genCode(record)">下载代码 </a-button>
                    </a-menu-item>
                  </a-menu>
                </template>
              </a-dropdown>
