  ...
  <div>
    <a-form class="smart-query-form">
      <a-row class="smart-query-form-row">
        <a-form-item label="输入框" class="smart-query-form-item">
          <a-input style="width: 300px" v-model:value="queryForm.tableColumn1" placeholder="请输入" allowClear />
        </a-form-item>
        <a-form-item label="选择框" class="smart-query-form-item">
          <a-select
            style="width: 300px"
        ...
        <a-form-item label="级联选择" class="smart-query-form-item">
          <a-cascader
            style="width: 300px"
        ...
        <a-form-item label="树形选择" class="smart-query-form-item">
          <a-tree-select
            style="width: 300px"
        ...
        <a-form-item label="单选框" class="smart-query-form-item">
    ...
    <a-card size="small" :bordered="false" :hoverable="true">
      ...
      <a-row style="margin-bottom: 15px;">
        <span>表单形式：</span>
        <a-radio-group v-model:value="currentType" size="small">
    ...
    <OperateDrawer ref="operateDrawer" :dict-map="dictMap" @reloadList="query" />
