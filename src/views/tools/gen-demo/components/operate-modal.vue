  ...
  >
    <a-form ref="formRef" :labelCol="{ span: 4 }" :labelWrap="true" :model="form" :rules="rules" :disabled="disabled">
      ...
      <a-form-item label="T7" name="tableColumn7">
        <a-checkbox-group v-model:value="tableColumn7CheckBox"
                          @change="val => {
              if (val) {
...
const rules = {
  ...
  tableColumn4: [
    {required: true, message: 'T4不能为空'}
  ],
  tableColumn5: [
    {required: true, message: 'T5不能为空'}
  ],
  tableColumn6: [
    {required: true, message: 'T6不能为空'}
  ],
  tableColumn7: [
    {required: true, message: 'T7不能为空'}
  ],
  tableColumn8: [
    {required: true, message: 'T8不能为空'}
  ],
  tableColumn9: [
    {required: true, message: 'T9不能为空'}
  ],
  tableColumn10: [
    {required: true, message: 'T10不能为空'}
  ],
  tableColumn11: [
    {required: true, message: 'T11不能为空'}
  ],
  tableColumn12: [
    {required: true, message: 'T12不能为空'}
  ],
  tableColumn13: [
    {required: true, message: 'T13不能为空'}
  ],
  tableColumn14: [
    {required: true, message: 'T14不能为空'}
  ]
};
