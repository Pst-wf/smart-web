<template>
  ...
  >
    <a-form ref="formRef" :labelCol="{ span: 3 }" :labelWrap="true" :model="form" :rules="rules">
      ...
      <a-form-item v-if="form.releaseType === '1'" label="机构" name="releaseValueFormat">
        <a-tree-select
      ...
      <a-form-item v-if="form.releaseType === '2'" label="岗位" name="releaseValueFormat">
        <a-select
          v-model:value="form.releaseValueFormat"
          mode="multiple"
          allowClear
      ...
      <a-form-item v-if="form.releaseType === '3'" label="角色" name="releaseValueFormat">
        <a-select
          v-model:value="form.releaseValueFormat"
          mode="multiple"
          allowClear
      ...
      <a-form-item v-if="form.releaseType === '4'" label="人员" name="releaseValueFormat">
        <a-select
          v-model:value="form.releaseValueFormat"
          mode="multiple"
          allowClear
